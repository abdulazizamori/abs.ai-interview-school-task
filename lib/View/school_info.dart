...
class SchoolInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final prov = Provider.of<SchoolProvider>(context);
    return Scaffold(
          appBar: AppBar(
            toolbarHeight: 120,
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                reusableTextField(prov.schoolInfo?.schoolName?? schoolName, Icons.school),
                const SizedBox(height: 15,),
                reusableTextField(prov.schoolInfo?.schoolAddress?? schoolAddress, Icons.location_on_rounded),
                const SizedBox(height: 15,),
                reusableTextField(prov.schoolInfo?.numberStudents.toString()?? studentsNo, Icons.person),
                const SizedBox(height: 15,),
                reusableTextField(prov.schoolInfo?.numberTeachers.toString()?? teachersNo, Icons.person),
                Padding(
